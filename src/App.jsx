...
import energo from '/assets/photos/energoefecturoba.jpg'
// ჩვენს შესახებ
...
export default function App() {
  ...
  const content = {
    'ქარ': {
      ...
      eduCard2D: 'სკაუტური ბანაკი ავატარი სამეგრელოს სკაუტების საიმიჯო ღონისძიებაა, რომელიც 2020 წლიდან დღემდე ტარდება წეიწადში 2 ჯერ, ზაფხულში და ზამთარში. ბანაკი დატვირთულია სათავგადასავო და შემეცნებითი აქტივობებით. ღონისძიების ბოლოს კი ტრადიციულად ტარდება გასკაუტების ცერემონია სადაც ახალბედა სკაუტებს პირველი ყელსახვევები გადაეცემათ.',
      eduCard3T: 'MOVA-ს საერთაშორისო ჯამბორი შვეიცარიაში',
      eduCard3D: '2022 წელს შვეიცარიაში ნაციონალური ჯემბორი ჩატარდა, სადაც მონაწილეობა 33 000 ევროპელი სკაუტი. ჩვენი ლიდერები 15 დღის განმავლობაში აღნიშნული ბანაკის უსაფთხოდ და ხარისხიანად ჩატარებისთვის თავდაუზოგავად შრომობდნენ. აღნიშნული ღონისძიება 14 წელიწადში ერთხელ ტარდება შვეიცარიაში. ეს მსოფლიო სკაუტების უსაყვარლესი ბანაკია !',
      eduCard4T: 'სკაუტი მასწავლებელი',
      eduCard4D: 'მასწავლებელი უკეთესი სამყაროსთვის! პროექტის ფარგლებში 40 მასწავლებელი გადავამზადეთ არაფორმალური განათლების მეთოდზე დაყრდნობილი აქტივობების მიხედვით. მასწავლებლებმა მონაწილეობა ზამთრის სკაუტურ ბანაკშიც მიიღეს.',
      ...
      youthCard3T: 'მეგზური',
      youthCard3D: `⚜️სამეგრელოს სკაუტური მოძრაობის ორგანიზაცია Action Against Hunger South Caucasus-და ზუგდიდის LAG-თან თანამშრომლობით მასშტაბური პროქტის განხორციელებას იწყებს! <br><br>
...
🌲🇬🇪🇦🇹ინიციატივა მხარდაჭერილია პროექ ,,FORWARD” ის ფარგლებში, ავსტრიის განვითარების სააგენტოს მიერ, ავსტრიის საერთაშორისო პარტნიორობის ფინანსური მხარდაჭერით.      <br/><br/>
      ...
      youthCard5D: 'გახდი ენერგოეფექტურობის სპეციალისტი – სამეგრელოს სკაუტური მოძრაობის ორგანიზაციის წარმატებული პროექტი!⚡<br><br>🌱პროექტის მიზანი საზოგადოებაში ენერგოეფექტურობის პრინციპებზე ცნობიერების ამაღლება და ენერგიის დაზოგვის პრაქტიკული ჩვევების დაუფლება იყო.<br><br>📌 საქართველოს ენერგეტიკული სექტორის რეფორმის პროგრამა (GESRP) ხორციელდება ევროკავშირისა და Kreditanstalt für Wiederaufbau (KfW)-ის ფინანსური მხარდაჭერით.<br><br> პროექტს ახორციელებს საერთაშორისო კონსორციუმი intec, GOPA-International Energy Consultants GmbH-ის ხელმძღვანელობით, ხოლო რეგიონალურ ენერგოეფექტურობის კამპანიას შპს MES ახორციელებს.',
    ...
    'ENG': {
      ...
      eduCard1D: 'Within the framework of our partnership with the Red Cross, our team stood on the front lines during the pandemic to help the most vulnerable groups. We launched awareness-raising and charitable campaigns. At the initial stage of the crisis, the Scouts were present at the most critical hotspots. It is a Scout’s duty to be useful and to help others!',
      eduCard2T: 'Scout Camp Avatar',
      eduCard2D: 'The Scout Camp “Avatar” is a flagship event of the Samegrelo Scouts, which has been held twice a year since 2020 — in summer and winter. The camp is filled with adventurous and educational activities. At the end of the event, a traditional Scout ceremony is held, where beginner Scouts are awarded their first neckerchiefs.',
